...
export default function Landing() {
  ...
  const cards = [
    ...
    },
    {
      ...
      description:
        "Higher education with diverse courses and career opportunities",
      icon: "🎓",
      color: "from-blue-600 to-blue-800",
    },
  ];
  ...
  const features = [
    {
      ...
      description: "End-to-end encrypted result verification",
    },
    {
      icon: "⚡",
      title: "Instant Access",
      description: "Get results within seconds of submission",
    },
    {
      icon: "📱",
    ...
    },
    {
      icon: "✅",
      title: "Verified Data",
      description: "All results are officially verified",
    },
  ];
    ...
    <div className="font-sans relative overflow-hidden">
      ...
      >
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 w-full text-center">
          ...
          <motion.p className="text-base sm:text-lg lg:text-xl text-gray-200 mt-4 sm:mt-6 max-w-2xl mx-auto leading-relaxed px-2">
            Institute of Technology & Business University — Secure & smart
            online results with cutting-edge technology.
          </motion.p>
      ...
      <section className="py-16 sm:py-20 bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <SectionHeading
            title="Why Choose ITBU?"
            subtitle="Experience the future of result management with our cutting-edge platform"
          />
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            {features.map((feature, i) => (
              <div
                key={i}
                className="bg-white rounded-2xl p-6 sm:p-8 shadow-lg hover:shadow-2xl transition transform hover:-translate-y-2 border border-gray-100 text-center"
              >
      ...
      <section id="stats" className="py-16 sm:py-20 bg-gray-900 text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <SectionHeading
            ...
            subtitle="Trusted by learners & educators worldwide"
          />
          <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            {stats.map((stat, i) => (
              <div
                key={i}
                className="bg-white/10 rounded-2xl p-6 sm:p-8 text-center border border-white/20"
              >
                <div className="text-3xl sm:text-4xl mb-2">{stat.icon}</div>
                <div
                  className={`text-2xl sm:text-4xl font-extrabold ${stat.color}`}
                >
                  {stat.value}
                </div>
      ...
      <section id="institutions" className="py-16 sm:py-20 bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <SectionHeading
            ...
            subtitle="Madrasa • School • Coaching • College"
          />
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            {cards.map((card, i) => (
              <div
